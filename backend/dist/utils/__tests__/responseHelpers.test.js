...
const responseHelpers_1 = __importDefault(require("../responseHelpers"));
...
describe('responseHelpers', () => {
    ...
    describe('Service Initialization', () => {
        test('initializes correctly', () => {
            expect(responseHelpers_1.default).toBeDefined();
        });
        test('has all required methods', () => {
            const methods = Object.getOwnPropertyNames(responseHelpers_1.default);
...
//# sourceMappingURL=responseHelpers.test.js.map