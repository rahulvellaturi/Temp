    ...
    try {
      ...
      setFilteredPolicies(userPolicies);
        ...
        },
        {
          ...
          description: 'Homeowners insurance with comprehensive coverage',
          property: {
        ...
        },
        {
          ...
          description: 'Individual health insurance plan with dental and vision'
        },
        {
          id: '5',
          type: 'AUTO',
          policyNumber: 'AUTO-2023-015',
          status: 'EXPIRED',
          premium: 1100,
          coverage: 45000,
          deductible: 500,
          ...
          endDate: '2023-12-31',
          nextPayment: '',
          description: 'Previous year auto insurance policy',
          vehicles: [
            {
              make: 'Honda',
              model: 'Civic',
